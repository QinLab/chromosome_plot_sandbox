---
title: "test manhattan, umichigan version"
...
print(ann)
ann[with(tb, chr==1 & ref_position>=21563 & ref_position< 25384)]<-2
print(ann)
ann<-factor(ann, levels=1:2, labels=c("", "spike"))
...
```{r}
createSampleGwasData<-function(chr.count=1, include.X=F) {
	chr<-c(); pos<-c()
